/* Dữ liệu và thiết lập riêng của hồ sơ mau-tai-khoan. Mã giao diện/phiên bản nằm trong file hệ thống dùng chung. */
window.BIO_CONFIG = {
  "profile": {
    "name": "Tên người dùng",
    "verified": true,
    "handle": "@taikhoan",
    "bio": "Trang liên kết cá nhân.",
    "avatar": "avatar.png",
    "footerText": "Thảo • Bio Link",
    "badges": [
      {
        "enabled": true,
        "icon": "map-pin",
    ...
    "translations": {
      "ja": {
        "name": "タオ",
        "bio": "タオのリンクページです。",
        "footerText": "タオ • Bio Link"
      },
      "en": {
        "name": "Thao",
        "bio": "This is Thao's link page.",
        "footerText": "Thao • Bio Link"
      }
    }
  },
  "settings": {
