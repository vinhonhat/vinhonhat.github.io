...
registerGame('math4', {
    ...
    renderDisplay: function (data) {
        ...
        for (let i = 0; i < data.left; i++) {
            leftHTML += `<img src="/img/game/${data.item.img}" class="math2-item" style="animation-delay:${i * 0.15}s">`;
        }

        // ITEM PHẢI (Tự động đổi ảnh dựa trên biến rightItemImg vừa check ở trên)
        let rightHTML = '';
        for (let i = 0; i < data.right; i++) {
            rightHTML += `<img src="/img/game/${rightItemImg}" class="math2-item" style="animation-delay:${i * 0.15}s">`;
        }
        ...
        <div class="math2-wrap">
            <div class="math2-groups">
                <div class="math2-basket">
                    <img src="/img/game/gio.png" class="basket-bg">
